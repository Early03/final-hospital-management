...
const Profile = ({user}) => {
  ...
  useEffect(()=>{
    setFormData({name:user.name, email:user.email, photo:user.photo, gender:user.gender, bloodType:user.bloodType, password:user.password})
  }, [user]);
    ...
    <div className='mt-10'>
      <form onSubmit={submitHandler}>
              ...
              <div className='mb-5 flex items-center gap-3'>
                {formData.photo &&
                  <figure className='w-[60px] h-[60px] rounded-full border-2 border-solid borded-primaryColor flex items-center justify-center'>
